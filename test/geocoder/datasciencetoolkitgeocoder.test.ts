...
describe('DataScienceToolkitGeocoder', () => {
  describe('#constructor', () => {
    test('an http adapter must be set', () => {
      ...
      }).to.throw(Error, 'DataScienceToolkitGeocoder need an httpAdapter');
    });
  ...
  describe('#geocode', () => {
    ...
    test('Should call httpAdapter get method with specified host', () => {
      ...
      mock
        .expects('get')
        .withArgs('http://raoul.io/ip2coordinates/127.0.0.1', {})
        .once()
        .returns({ then: function () {} });
    ...
    test('Should error for no result', (done: any) => {
      ...
      geocoder.geocode(
        '2543 Graystone Place, #123, Simi Valley, CA 93065',
        function (err: any) {
  ...
  describe('#reverse', () => {
    test('Should throw an error', () => {
      ...
      expect(() => {
        ...
        Error,
        'DataScienceToolkitGeocoder does not support reverse geocoding'
      );
    });
  });
});
