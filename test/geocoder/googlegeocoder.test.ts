...
describe('GoogleGeocoder', () => {
  ...
  describe('#constructor', () => {
    test('an http adapter must be set', () => {
      ...
      }).toThrow('GoogleGeocoder need an httpAdapter');
    });
    ...
    test('Should be an instance of GoogleGeocoder if an http adapter is provided', () => {
      const adapter = new GoogleGeocoder(mockedHttpAdapter, {});
  ...
  describe('#geocode', () => {
    test('Should not accept IPv4', async () => {
      ...
      await expect(adapter.geocode('127.0.0.1')).rejects.toEqual(new ValueError('GoogleGeocoder does not support geocoding IPv4'));
    });
    ...
    test('Should not accept IPv6', async () => {
      ...
      )).rejects.toEqual(new ValueError('GoogleGeocoder does not support geocoding IPv6'));
    });
