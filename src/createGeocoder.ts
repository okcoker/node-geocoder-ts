...
import HereGeocoder, {
  Options as HereOptions
} from './provider/here/HereProvider';
import AGOLProvider, {
  Options as AGOLOptions
} from './provider/agol/AGOLProvider';
...
> {
  ...
  const adapter = _getGeocoderAdapter(
    httpAdapter,
    geocoderOptions as AllAdapterOptions
  );
